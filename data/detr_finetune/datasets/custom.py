...
def build(image_set, args):
    ...
    training_json_file = 'ann_train.json'
    validation_json_file = 'ann_val.json'
    PATHS = {
        "train": (root / "images", root / "annotation" / training_json_file),
        "val": (root / "images", root / "annotation" / validation_json_file),
    }
